...
public class SachBCFragments extends Fragment{
    ...
    public SachBCFragments() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_sach_bc,null);

        ListView listView = (ListView) v.findViewById(R.id.lvListBC);
